...
from libnlp.clib import nlp_cc

__all__ = ['nlpcc', 'CONFIGS', '__version__']

__version__ = nlp_cc.__version__
...
_nlpcc_share_dir = os.path.join(_thisdir, 'clib', 'share', 'libnlp','normalize','cc')
