...
#ifdef _MSC_VER
            static std::wstring get_platform_string(const std::string& str) {
              return U8ToU16(str);
            }
#else
            static std::string get_platform_string(const std::string& str) { return str; }
#endif // _MSC_VER
